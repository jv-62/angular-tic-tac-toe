...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function _src_app_appComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function AppComponent_div_11_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_div_11_Template_div_click_0_listener() {
    ...
    function AppComponent_div_13_span_4_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function AppComponent_div_13_span_5_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    ...
    function AppComponent_div_13_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_div_13_Template_button_click_8_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r12);

          var ctx_r11 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r11.reloadGame();
        });
    ...
    var AppComponent = /*#__PURE__*/function () {
      function AppComponent(toastr) {
        ...
        this.poppers = []; // t0 t1 t2
        // t3 t4 t5
        // t6 t7 t8

        this.checkIsWinner = function () {
          //  checking  winner of the game
          if (_this.itemArray[0] === _this.itemArray[1] && _this.itemArray[0] === _this.itemArray[2] && _this.itemArray[0] !== 'empty') {
            _this.winMessage = "".concat(_this.itemArray[0], " won");

            _this.playWinSound();

            _this.triggerPartyPoppers();
          } else if (_this.itemArray[3] !== 'empty' && _this.itemArray[3] === _this.itemArray[4] && _this.itemArray[4] === _this.itemArray[5]) {
            _this.winMessage = "".concat(_this.itemArray[3], " won");

            _this.playWinSound();

            _this.triggerPartyPoppers();
          } else if (_this.itemArray[6] !== 'empty' && _this.itemArray[6] === _this.itemArray[7] && _this.itemArray[7] === _this.itemArray[8]) {
            _this.winMessage = "".concat(_this.itemArray[6], " won");

            _this.playWinSound();

            _this.triggerPartyPoppers();
          } else if (_this.itemArray[0] !== 'empty' && _this.itemArray[0] === _this.itemArray[3] && _this.itemArray[3] === _this.itemArray[6]) {
            _this.winMessage = "".concat(_this.itemArray[0], " won");

            _this.playWinSound();

            _this.triggerPartyPoppers();
          } else if (_this.itemArray[1] !== 'empty' && _this.itemArray[1] === _this.itemArray[4] && _this.itemArray[4] === _this.itemArray[7]) {
            _this.winMessage = "".concat(_this.itemArray[1], " won");

            _this.playWinSound();

            _this.triggerPartyPoppers();
          } else if (_this.itemArray[2] !== 'empty' && _this.itemArray[2] === _this.itemArray[5] && _this.itemArray[5] === _this.itemArray[8]) {
            _this.winMessage = "".concat(_this.itemArray[2], " won");

            _this.playWinSound();

            _this.triggerPartyPoppers();
          } else if (_this.itemArray[0] !== 'empty' && _this.itemArray[0] === _this.itemArray[4] && _this.itemArray[4] === _this.itemArray[8]) {
            _this.winMessage = "".concat(_this.itemArray[0], " won");

            _this.playWinSound();

            _this.triggerPartyPoppers();
          } else if (_this.itemArray[2] !== 'empty' && _this.itemArray[2] === _this.itemArray[4] && _this.itemArray[4] === _this.itemArray[6]) {
            _this.winMessage = "".concat(_this.itemArray[2], " won");

            _this.playWinSound();

            _this.triggerPartyPoppers();
          } else if (_this.itemArray[0] !== 'empty' && _this.itemArray[1] !== 'empty' && _this.itemArray[2] !== 'empty' && _this.itemArray[3] !== 'empty' && _this.itemArray[4] !== 'empty' && _this.itemArray[5] !== 'empty' && _this.itemArray[6] !== 'empty' && _this.itemArray[7] !== 'empty' && _this.itemArray[8] !== 'empty') {
            _this.winMessage = 'Game Draw';
            _this.isGameDraw = true;
          }
        };

        this.reloadGame = function () {
          _this.winMessage = '';
          _this.isGameDraw = false;
          _this.isCross = false;
      ...
      return _createClass(AppComponent, [{
        ...
        value: function playWinSound() {
          ...
          setTimeout(function () {
            return _this2.playSound(1000, 0.15, 100);
          }, 150);
          setTimeout(function () {
            return _this2.playSound(1200, 0.15, 200);
          }, 300);
        }
      }, {
        key: "playSound",
        value: function playSound(frequency, volume, duration) {
          try {
        ...
        key: "triggerPartyPoppers",
        value: function triggerPartyPoppers() {
          var _this3 = this;
          ...
          for (var i = 0; i < popperCount; i++) {
            _loop(i);
          }

          setTimeout(function () {
            _this3.showPoppers = false;
          }, 3000);
        }
      }, {
        key: "handleClick",
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      directives: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["NgClass"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["NgForOf"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["NgIf"], _components_icon_icon_component__WEBPACK_IMPORTED_MODULE_3__["IconComponent"]],
  ...
  function _src_app_appModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*! ngx-toastr */
    "./node_modules/ngx-toastr/__ivy_ngcc__/fesm2015/ngx-toastr.js"); // Font Awesome
    // Toaster
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      providers: [],
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_6__["BrowserAnimationsModule"], ngx_toastr__WEBPACK_IMPORTED_MODULE_7__["ToastrModule"].forRoot(), _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_5__["FontAwesomeModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"]]]
    });
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        ...
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_6__["BrowserAnimationsModule"], ngx_toastr__WEBPACK_IMPORTED_MODULE_7__["ToastrModule"], _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_5__["FontAwesomeModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  /***/
  function _src_app_components_icon_iconComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Users/jayamverma/Documents/Jayam/Projects/Github/angular-tic-tac-toe/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
